...
namespace MagicHour
{
    ...
    public sealed partial class VideoProjectsGetDetailsResponse
    {
        ...
        /// <summary>
        /// The type of the video project. Possible values are ANIMATION, AUTO_SUBTITLE, VIDEO_TO_VIDEO, FACE_SWAP, TEXT_TO_VIDEO, IMAGE_TO_VIDEO, LIP_SYNC, TALKING_PHOTO, VIDEO_UPSCALER, VIDEO_EDITOR, CHARACTER_REPLACE, VIDEO_COLORIZER, EXTEND, AUDIO_TO_VIDEO, VIDEO_EXPANDER, UGC_AD<br/>
        /// Example: FACE_SWAP
        /// </summary>
