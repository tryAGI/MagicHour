...
namespace MagicHour
{
    ...
    public sealed partial class ImageProjectsGetDetailsResponse
    {
        ...
        /// <summary>
        /// The type of the image project. Possible values are FACE_EDITOR, AI_IMAGE_EDITOR, AI_SELFIE, AI_HEADSHOT, AI_IMAGE, AI_MEME, CLOTHES_CHANGER, BACKGROUND_REMOVER, FACE_SWAP, IMAGE_UPSCALER, AI_GIF, QR_CODE, PHOTO_EDITOR, PHOTO_COLORIZER, HEAD_SWAP, BODY_SWAP, STORYBOARD<br/>
        /// Example: AI_IMAGE
        /// </summary>
