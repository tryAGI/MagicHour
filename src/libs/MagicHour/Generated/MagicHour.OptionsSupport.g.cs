...
namespace MagicHour
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::MagicHour.AutoSDKRetryOptions Retry { get; set; } = new global::MagicHour.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::MagicHour.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::MagicHour.IAutoSDKHook>();
        ...
        public global::MagicHour.AutoSDKClientOptions AddHook(
            global::MagicHour.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::MagicHour.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::MagicHour.AutoSDKClientOptions UseAuthorizationProvider(
            global::MagicHour.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::MagicHour.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::MagicHour.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::MagicHour.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::MagicHour.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::MagicHour.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::MagicHour.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::MagicHour.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::MagicHour.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::MagicHour.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::MagicHour.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::MagicHour.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::MagicHour.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::MagicHour.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::MagicHour.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::MagicHour.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::MagicHour.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::MagicHour.AutoSDKClientOptions clientOptions,
            global::MagicHour.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::MagicHour.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::MagicHour.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::MagicHour.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::MagicHour.AutoSDKClientOptions clientOptions,
            global::System.Func<global::MagicHour.IAutoSDKHook, global::MagicHour.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::MagicHour.AutoSDKHookContext context)
        {
