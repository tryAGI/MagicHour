...
namespace MagicHour
{
    ...
    public sealed partial class VideoAssetsGeneratePresignedUrlRequestItem
    {
        ...
        /// <summary>
        /// The extension of the file to upload. Do not include the dot (.) before the extension. Possible extensions are mp4,m4v,mov,webm,mp3,wav,aac,flac,webm,weba,m4a,opus,ogg,oga,aiff,amr,png,jpg,jpeg,jfif,heic,heif,webp,avif,jp2,tiff,tif,bmp,gif,webp,webm<br/>
        /// Example: mp4
        /// </summary>
        /// <example>mp4</example>
