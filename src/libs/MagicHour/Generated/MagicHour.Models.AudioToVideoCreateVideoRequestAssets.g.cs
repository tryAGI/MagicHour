...
namespace MagicHour
{
    ...
    public sealed partial class AudioToVideoCreateVideoRequestAssets
    {
        ...
        /// <summary>
        /// Reference image for the initial frame of the video. This value is either<br/>
        /// - a direct URL to the video file<br/>
        /// - `file_path` field from the response of the [upload urls API](https://docs.magichour.ai/api-reference/files/generate-asset-upload-urls).<br/>
        /// See the [file upload guide](https://docs.magichour.ai/api-reference/files/generate-asset-upload-urls#input-file) for details.<br/>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioToVideoCreateVideoRequestAssets" /> class.
        /// </summary>
...
#endif
        public AudioToVideoCreateVideoRequestAssets(
