...
namespace MagicHour
{
    ...
    {
        /// <summary>
        /// The image used to generate the headshot. This image must contain one detectable face. This value is either<br/>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AiHeadshotGeneratorCreateImageRequestAssets" /> class.
        /// </summary>
...
#endif
        public AiHeadshotGeneratorCreateImageRequestAssets(
